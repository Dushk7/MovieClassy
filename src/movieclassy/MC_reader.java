 ...
 */
	 ...
	 * */
		...
		public static String getPercentage(HashMap<String, Double> dg){
			 ...
			 * */
			double [] genreArray= new double[dd.length];
			double temp;
                        String tempGen;
                        int count=0,min=0;
			...
			for(int j = 0; j<dd.length; j++){
				...
				//}
                        ...
                        while(count<2){  
                            for(int c=0 ;c<2;c++){
                                ...
                                for(int d = 0 ; d<dd.length ;d++ ){
                                    if(genreArray[min]<genreArray[d] ){
                                        if(count == 0) first =min;
                                        if(count == 1) second = min;
                                        //temp=genreArray[c];
                                        //tempGen=genres[c];

                                        //genreArray[c]=genreArray[d];
                                        //genreArray[d]=temp;
                                    ...
                                    else if (genreArray[min]>genreArray[d] ){
                                        min=d;
                                        if(count == 0) first = min;
                                        if(count == 1) second = min;
                        ...
                        //result = "Best 2 catogories";
                        
                        //result = genreArray[0] +" "+  genreArray[1] +" "+ genreArray[2] +" "+  genreArray[3] +" "+ genreArray[4] +" "+  "\n" + genres[first] + " " + genres[second];
                        
                        //result2 = first + " " + second + " " +genres[0]+" "+genres[1]+" "+genres[2]+" "+genres[3]+" "+genres[4];
